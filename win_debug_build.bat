...
cl /nologo /Zi /utf-8 /validate-charset gdi32.lib msvcrt.lib raylib.lib winmm.lib user32.lib shell32.lib ..\..\..\src\gasoline_metronome.c ..\..\..\src\gasoline_timing.c ..\..\..\src\gasoline_audio.c -I..\..\..\src\lib\raylib\raylib-5.5_win64_msvc16\include /link /libpath:..\..\..\src\lib\raylib\raylib-5.5_win64_msvc16\lib /NODEFAULTLIB:libcmt
