...
//                                                                              //
// USAGE: On init call: GuiLoadStyleGmDefaultStyle();                                   //
//                                                                              //
...
#define GM_DEFAULT_STYLE_STYLE_PROPS_COUNT  16

// Custom style name: gm_default_style
static const GuiStyleProp gm_default_styleStyleProps[GM_DEFAULT_STYLE_STYLE_PROPS_COUNT] = {
    { 0, 0, (int)0xc1490eff },    // DEFAULT_BORDER_COLOR_NORMAL 
    { 0, 1, (int)0x3e0e0eff },    // DEFAULT_BASE_COLOR_NORMAL 
    { 0, 2, (int)0xe1cdcdff },    // DEFAULT_TEXT_COLOR_NORMAL 
    { 0, 3, (int)0xe45200ff },    // DEFAULT_BORDER_COLOR_FOCUSED 
    { 0, 4, (int)0xd6300bff },    // DEFAULT_BASE_COLOR_FOCUSED 
    { 0, 5, (int)0x000000ff },    // DEFAULT_TEXT_COLOR_FOCUSED 
    { 0, 6, (int)0xec7d06ff },    // DEFAULT_BORDER_COLOR_PRESSED 
    { 0, 7, (int)0xb21014ff },    // DEFAULT_BASE_COLOR_PRESSED 
    { 0, 8, (int)0xe9d1d1ff },    // DEFAULT_TEXT_COLOR_PRESSED 
    { 0, 9, (int)0x4b3131ff },    // DEFAULT_BORDER_COLOR_DISABLED 
    { 0, 10, (int)0x340f0fff },    // DEFAULT_BASE_COLOR_DISABLED 
    { 0, 11, (int)0x717171ff },    // DEFAULT_TEXT_COLOR_DISABLED 
    { 0, 16, (int)0x00000010 },    // DEFAULT_TEXT_SIZE 
    { 0, 18, (int)0x7f0003ff },    // DEFAULT_LINE_COLOR 
    { 0, 19, (int)0x252525ff },    // DEFAULT_BACKGROUND_COLOR 
    { 0, 20, (int)0x00000018 },    // DEFAULT_TEXT_LINE_SPACING 
};

// WARNING: This style uses a custom font: "" (size: 16, spacing: 1)

#define GM_DEFAULT_STYLE_STYLE_FONT_ATLAS_COMP_SIZE 2138

// Font atlas image pixels data: DEFLATE compressed
static unsigned char gm_default_styleFontData[GM_DEFAULT_STYLE_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
static const Rectangle gm_default_styleFontRecs[189] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 9 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 9 },
...
static const GlyphInfo gm_default_styleFontGlyphs[189] = {
    { 32, 0, 0, 4, { 0 }},
    { 33, 2, 4, 5, { 0 }},
    { 34, 2, 4, 7, { 0 }},
    { 35, 1, 4, 8, { 0 }},
...
// Style loading function: gm_default_style
static void GuiLoadStyleGmDefaultStyle(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < GM_DEFAULT_STYLE_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(gm_default_styleStyleProps[i].controlId, gm_default_styleStyleProps[i].propertyId, gm_default_styleStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int gm_default_styleFontDataSize = 0;
    unsigned char *data = DecompressData(gm_default_styleFontData, GM_DEFAULT_STYLE_STYLE_FONT_ATLAS_COMP_SIZE, &gm_default_styleFontDataSize);
    ...
    memcpy(font.recs, gm_default_styleFontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, gm_default_styleFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
